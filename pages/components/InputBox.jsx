    ...
    return (
        <div className='p-3 mx-auto flex flex-col gap-2 bg-white rounded-xl'>
            ...
            <div className='flex justify-between space-x-3 font-semibold py-1'>
                ...
                <div onClick={() => filePickerRef.current.click()} className='flex gap-1 hover:bg-gray-200 cursor-pointer rounded-md p-2 text-gray-600 lg:text-base md:text-sm text-xs items-center justify-center'><PhotoIcon className='lg:h-6 md:h-5 h-4 text-green-600' />
